# Kanban: Create a Literate Spec for Configurations

    **Document Type**: Kanban 
    **Creation Date**: 2025-04-05
    **Project Code**: CONFIG-SPEC
    **Resource Identifer**: urn:oa:docs:kanban#CONFIG-SPEC

## Active Tasks 

### **Task 002**: Use Literate Specs In Development to Actualise Literate Capabilities 
...
- OA-NOTE-31: urn:oa:docs:note#NOTE-031
...
### **Task 001**: Preparing a Literate Specification for Creating, Tracking and Managing Specifications

**Description**

Analyse the current specifications configuration, and aligh with `XDG_BASE_DIR`s 

> **TODO** REVIEW TASK `CONFIG-SPEC.001` BY COMPLETING ALL THE CHECKLISTS
