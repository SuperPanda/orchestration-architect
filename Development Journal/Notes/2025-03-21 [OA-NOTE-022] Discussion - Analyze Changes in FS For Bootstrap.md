...
Here's a simpler approach using `tree` with timestamped snapshots and diff analysis. I'll provide a complete bash-based solution with visualization, then show how to port it to Rust for better performance:
