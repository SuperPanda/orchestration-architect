...
# ╔═╡ d49849e9-252c-44c6-9040-aef5cf5750df
begin
	# Include the CategoryWiring module
	include("/home/panda/Notes/CategoryWiring.jl")
	using Catlab
	using .CategoryWiring
	import .CategoryWiring as CW
end

# ╔═╡ f4ce9fe4-7a5b-11ef-1fee-41c5711ee6a5
begin	
	# Define a category with objects and morphisms
	local diagram = CW.@category([:Specification, :Template, :CodeFragment, :CodeOutput],
	               [(:Specification, :Template), (:Template, :CodeFragment), (:CodeFragment, :CodeOutput)])
	
	# Visualize the category
	svg_output = CW.visualize_category(diagram)
end

# ╔═╡ d5c2de7f-c7fc-49f1-bbc9-1c767c1954f0
...
manifest_format = "2.0"
project_hash = "252509bfa1f89ab2b79d10db38c022e22583b74d"
