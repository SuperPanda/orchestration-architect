...
# ╔═╡ bb7bcd9a-ad80-4a75-9881-2744e607fc2c
using TikzPictures

# ╔═╡ c64acbb6-cb3f-4a74-8306-9fb97e769bf8
md"
...
Metadata should come from rdfs
"

# ╔═╡ 7cee1dfd-9b80-4bc0-9fb1-4b971a8b013d
"""Metadata should come from rdfs"""

# ╔═╡ 519a5537-865a-4729-ac16-20db0a9936ab
resources = Dict(
	:base_path => ENV["HOME"],
	:documents => Dict(
...
# ╔═╡ 734d0cbf-3d26-4b4e-b971-4c81f89d24d1
# ╠═╡ disabled = true
#=╠═╡
begin
	using Accessors;
	lens = @optic (_);
	base_path = lens(resources)
	
end
  ╠═╡ =#

# ╔═╡ 4eff3c3a-05f3-4e97-887e-648c225e8dcd
#=╠═╡
base_path
  ╠═╡ =#

# ╔═╡ 99183afc-86ae-11ef-3d43-d9465fe4b7e4
mkpath("Notes/Design/Feature";mode=0o750)

# ╔═╡ 65567794-70b6-4369-9e9b-a12717c87373
joinpath([ENV["HOME"], "Notes/Design/Feature"])

# ╔═╡ 673d2209-0cb5-4288-a50e-533614200020
kanban = Dict(:states=>["backlog","active","complete","archive"])

# ╔═╡ d80d16eb-e967-47e5-89a5-6d45aebd42d3
kanban[:states]

# ╔═╡ dfd72fff-5a46-49e6-8666-0cf5e788a1c2
# ╠═╡ disabled = true
#=╠═╡
kanban[:states]
  ╠═╡ =#

# ╔═╡ 6b9f735a-c375-4563-b240-7a81e6e9edaa
md"""
...
| ------------- | --------------------------------------------- |
| Title         | Feature Specification: Kanban                 |
| Short Code    | OA\_FEATURE\_001                              |
| Domain        | OA\_PROJECT (Orchestration Architect Project) |
| URN           | oa\:documents/Specs/Feature/Kanban            |
| Branch        | 0.8.0-documents                               |
| Document Type | Feature Specification                         |
| Status        | Draft                                         |
...
# ╔═╡ 424b8069-f213-4fea-a38b-f6c14220cad1
### **10. Example Diagram with TikZ**

TikzPicture(L"\begin{tikzpicture}
  \node[rectangle, draw] (backlog) at (0,0) {Backlog};
  \node[rectangle, draw] (active) at (3,0) {Active};
  \node[rectangle, draw] (complete) at (6,0) {Complete};
\end{tikzpicture}
")
...
manifest_format = "2.0"
project_hash = "c4d171ec96cffbcf325b8582a7c19138749ea17b"
