...
PUT GIT COMMUTATIVE DIAGRAM HERE
...
- **TODO**: Add the problems that literate writing solves, keeping track of the different systems



- **TODO**: Allows for substitution with all the dependents being reusable so it helps with Minksky 2008 hierarchical (add the quote)
