...
- **[project.README.md](/documents/project/project.README.md)**: Describes the task management process, how tasks are tracked using symlinks, and how the Kanban board is generated.
