...
## Appendix Imported Modelling

### 

### ARCHITECTURE DIAGRAM

Trying to figure out what to put in this document. 
...
Capability View: {        
    ...
    Outcomes: { 
        grid-columns: 1;
        Repeatable; Compressible; Globally Updating; Understandable; Automatic Cascade; Recoverable;
    }
}
Operational View: {
