# Literate Architecture: Setup Prerequiste Preprocessors

<!--toc:start-->
- [Literate Architecture: Setup Prerequiste Preprocessors](#literate-architecture-setup-prerequiste-preprocessors)
  - [1. Required Capability: Render D2 Diagrams](#1-required-capability-render-d2-diagrams)
  ...
  - [2. Required Capability: Using commands to auto-populate documentation](#2-required-capability-using-commands-to-auto-populate-documentation)
...
## 1. Required Capability: Render D2 Diagrams
...
---
## 2. Required Capability: Using commands to auto populate documentation
